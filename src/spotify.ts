...
const redirectUri = "https://spotify-app-two-jet.vercel.app/";
...
export const getRecommendations = async (
  ...
  await axios
    .get(
      `https://api.spotify.com/v1/recommendations?seed_artists=${artistID}&seed_genres=${genre}&seed_tracks=${trackID}&target_popularity=${popularity}&limit=40`,
      {
        headers: {
          Accept: "application/json",
          Authorization: `Bearer ${userToken}`,
...
export const getGenres = async (userToken: string, setGenres: any) => {
  await axios
